...
KCPTUN_SNDWND=${KCPTUN_SNDWND:-512}                           #"sndwnd": 512,
KCPTUN_RCVWND=${KCPTUN_RCVWND:-512}                           #"rcvwnd": 512,
KCPTUN_NOCOMP=${KCPTUN_NOCOMP:-false}                         #"nocomp": false
# ======= ROOT CONFIG ======
ROOT_PASSWORD=${ROOT_PASSWORD:-root}                          #default-root-password: root
